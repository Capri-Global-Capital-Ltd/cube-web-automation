package testcases.cube.salaryLogin;
...
public class SalaryLogin extends BaseFile {

	private static final String TESTCASES_SHEET = "CUBE";
	private static final String SHEET_NAME = "CUBE_SHEET";
	...
	public void cubeLoginPage(Map<String, Object> fetchData) throws InterruptedException {
