package testcases.cube.driverLogin;
...
import pages.cube.driverLogin.loginDriver;

import property.PropertyFile;
import utility.BaseFile;

public class TestLoginDriver extends BaseFile {

	private static final String TESTCASES_SHEET = "CUBEDriver";
	private static final String SHEET_NAME = "CUBEDriver_SHEET";
	private ExtentReports extent;
	private WebDriver driver;
	private loginDriver loginPage;
	...
	private void navigateToBaseURL() throws Exception {
		...
		loginPage = new loginDriver(driver, 10);
		loginPage.openURL();
		extent = extentBase;
	...
	public void loginDriver(Map<String, Object> fetchData) throws InterruptedException {
