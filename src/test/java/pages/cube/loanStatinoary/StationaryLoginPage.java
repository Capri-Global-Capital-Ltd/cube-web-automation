package pages.cube.loanStatinoary;
...
public class StationaryLoginPage extends CommonKeyWords {
	...
	public StationaryLoginPage(WebDriver driver, long timeoutInSeconds) {
