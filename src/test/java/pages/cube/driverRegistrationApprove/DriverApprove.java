package pages.cube.driverRegistrationApprove;
...
public class DriverApprove extends CommonKeyWords {
	...
	public DriverApprove(WebDriver driver, long timeoutInSeconds) {
